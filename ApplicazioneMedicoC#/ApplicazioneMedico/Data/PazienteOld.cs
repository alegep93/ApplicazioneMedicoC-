...
namespace ApplicazioneMedico.Data
{
    public class PazienteOld
    {
        ...
        public PazienteOld(int id, string nome, string cognome, string luogoNascita, string codiceFiscale, string residenza, string provincia, string indirizzo, string telefono, string cellulare, string email, string codiceSanitario, string codiceMedico, DateTime dataNascita, DateTime dataUpdate, DateTime dataInserimento)
        {
            this.id = id;
            this.nome = nome;
